...
class TrafficGenerator:
    def __init__(self, max_steps, n_cars_generated, percentage_CV):
        self._n_cars_generated = n_cars_generated  # how many cars per episode
        self._max_steps = max_steps
        self._percentage_CV = percentage_CV
            ...
            for car_counter, step in enumerate(car_gen_steps):
                ...
                if straight_or_turn < 0.75:  # choose direction: straight or turn - 75% of times the car goes straight
                    ...
                    if route_straight == 1:
                        ...
                        CVs.append("W_E_"+str(car_counter))
                        ...
                        CVs.append("E_W_"+str(car_counter))
                        ...
                        CVs.append("N_S_"+str(car_counter))
                    else:
                        ...
                        CVs.append("S_N_"+str(car_counter))
                    ...
                    if route_turn == 1:
                        ...
                        CVs.append("W_N_"+str(car_counter))
                    elif route_turn == 2:
                        ...
                        CVs.append("W_S_"+str(car_counter))
                    elif route_turn == 3:
                        ...
                        CVs.append("N_W_"+str(car_counter))
                    elif route_turn == 4:
                        ...
                        CVs.append("N_E_"+str(car_counter))
                    elif route_turn == 5:
                        ...
                        CVs.append("E_N_"+str(car_counter))
                    elif route_turn == 6:
                        ...
                        CVs.append("E_S_"+str(car_counter))
                    elif route_turn == 7:
                        ...
                        CVs.append("S_W_"+str(car_counter))
                    elif route_turn == 8:
                        ...
                        CVs.append("S_E_"+str(car_counter))

            print("</routes>", file=routes)
            CVs = np.random.choice(CVs,(self._percentage_CV*len(CVs)//100),replace=False)
            return CVs
